 ...
 * @author user
 */
public class ImageConvolutionSpatial 
{
    public int [][] convolution( int [][]mix1,int [][] kernal)//整數 卷積運算 int [][] kernal
    {
       int step=1;//卷積步長
       ...
       for(int j=0;centerY<h1-s1;j++)//垂直走
        {
            ...
            for(int i=0;centerX<w1-s1;i++)//水平走
            {
                ...
                for(int q=startY,t=0;q<=endY;q++,t++)//垂直走
                {
                    ...
                    {
                        //System.out.print("M("+q+","+p+")"+" ");
                        int dot=mix1[q][p]*kernal[t][r];
                        System.out.print(mix1[q][p]+"*"+ kernal[t][r]+"="+dot+" ");
                        dotSum+=dot;
                    }
                  
                    System.out.println();
                }
                System.out.println("dot sum ="+dotSum);
                //
